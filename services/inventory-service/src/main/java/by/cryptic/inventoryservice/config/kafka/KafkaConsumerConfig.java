package by.cryptic.inventoryservice.config.kafka;
...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<@NonNull String, @NonNull DomainEvent> kafkaListenerContainerFactory(
        ...
        factory.getContainerProperties().setGroupId("inventory-consumer-group");
    ...
    public ConcurrentKafkaListenerContainerFactory<@NonNull String, @NonNull String> stringKafkaListenerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka-0.kafka-headless.messaging.svc.cluster.local:9090,kafka-1.kafka-headless.messaging.svc.cluster.local:9090,kafka-2.kafka-headless.messaging.svc.cluster.local:9090");
